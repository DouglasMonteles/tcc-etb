        ...
        <script>
            function excluir(index,item,qtd){
                if(confirm("Tem certeza que quer excluir o item: "+item+"?")){
                    window.open("gerenciar_carrinho.do?op=del_c&qtd="+qtd+"&index="+index,"_self");
                }
            }
        </script>
