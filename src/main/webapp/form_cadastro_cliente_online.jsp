...
<html lang="pt-br">
    <head>
        ...
        <script>
            function pegaCpf(){
                ...
                document.getElementById('inputUserCliente').value=cpf;
            }
    ...
    <body>
        <div class="row bg-dark w-100" style="height: 200px"></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <form id="regForm" action="gerenciar_cliente.do" method="post">
                                <input type="hidden" name="tipo" value="inserir_online">
                                ...
                                <div class="tab"> 
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-sm-12">
                                            ...
                                            <input id="cpf" class="form-control" type="text" id="inputCpfCliente" name="cpf" required>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-row">
                                                <div class="form-group col-sm-6">
                                                    ...
                                                    <input id="cel" class="form-control" type="tel" id="inputTelCel" name="tel_celular" required>
                                                </div>

                                                <div class="form-group col-sm-6">
                                                    <label for="inputTelFixo">Tel. Fixo</label>
                                                    <input id="tel" class="form-control" type="tel" id="inputTelCel" name="tel_fixo" required>
                                                </div>
                                            </div>
