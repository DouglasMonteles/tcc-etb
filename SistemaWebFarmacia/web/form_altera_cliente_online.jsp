                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <form id="regForm" action="gerenciar_cliente.do" method="post">
                                <input type="hidden" name="tipo" value="alterarPorCliente">
                                ...
                                <div class="tab"> 
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-sm-12">
                                            ...
                                            <input class="form-control" type="text" id="inputCpf" name="cpf" value="<%= c.getCpf() %>" required>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-row">
                                                <div class="form-group col-sm-6">
                                                    ...
                                                    <input class="form-control" type="tel" id="inputTelCel" name="tel_celular"  value="<%= c.getTelCelular()%>" required>
                                                </div>

                                                <div class="form-group col-sm-6">
                                                    <label for="inputTelFixo">Tel. Fixo</label>
                                                    <input class="form-control" type="tel" id="inputTelCel" name="tel_fixo"  value="<%= c.getTelFixo() %>" required>
                                                </div>
                                            </div>
